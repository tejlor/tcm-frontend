  ...
  ToastrConfirm.prototype.render = function render() {
    ...
    return _react2.default.createElement(
      ...
      _react2.default.createElement(
        ...
        _react2.default.createElement(
          'footer',
          { className: 'w3-padding w3-light-grey' },
		   _react2.default.createElement(
		   'div',
		   { className: 'w3-bar w3-center' },
			  !this.containsOkButton(options.buttons) && _react2.default.createElement(
				_Button2.default,
				{ className: 'w3-button w3-round w3-green', onClick: function onClick() {
			  ...
			  !this.disableCancel && !this.containsCancelButton(options.buttons) && _react2.default.createElement(
				_Button2.default,
				{ className: 'w3-button w3-round w3-red', onClick: this.handleCancelClick.bind(this) },
				this.cancelText
			  )
		  )
        )
